...
public abstract class CryptTombKeeper {
	...
	protected void setCipher(String transformationAlgo) throws NoSuchAlgorithmException, NoSuchPaddingException {
	...
	protected void setMessageDigest(String algo) throws NoSuchAlgorithmException {
