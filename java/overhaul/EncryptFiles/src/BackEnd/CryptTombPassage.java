...
public class CryptTombPassage extends CryptTombKeeper {
	...
	public static final int DEFAULT_IV_PARAM_SPEC_SIZE = 16; // Init. Vector's default len. for 128-AES encryption
	...
	public void initialize(int opMode) throws GeneralSecurityException {
		init();
	...
	private IvParameterSpec getIvParameterSpec(final byte[] input, final int size) {
		...
		byte[] requiredBytes = copyOf(input, size);
